...
void CSVHandler::exportBTreeToCPP() {
    ...
    // Open the file in append mode to add data to csvAaryan.cpp
    ofstream cppFile("csvAaryan.cpp", ios::app);
    if (!cppFile.is_open()) {
        cerr << "Failed to open csvAaryan.cpp for writing." << endl;
        return;
    }

    // Write each record from the BTree to the file
    cppFile << "\n// Exported Data from BTree\n";
    for (const auto& record : data) {
        ...
        cppFile << "ID: " << id << ", Name: " << name << ", Age: " << age << ", Salary: " << salary << ";\n";
    }
...
int main(){
    BTree b(4);
    b.insert(101, "Bhargav", 19, 100000.0);
    b.insert(102, "Aurindum", 19, 120000.0);
...
// // Exported Data from BTree
// ID: 101, Name: Bhargav, Age: 19, Salary: 100000;
// ID: 102, Name: Aurindum, Age: 19, Salary: 120000;
